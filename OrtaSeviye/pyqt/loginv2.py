...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        ###kontrol
        login_button.clicked.connect(self.kontrol)
    ...
    def login(self):
        ...
        if username == "amdin" and password == "1234":
            QMessageBox.information(self,"Başarılı","Giriş BAŞARLI\nAna Programdasınız")
            self.rehberEkran=cmInchCevirici.TicariWindow()
            self.rehberEkran.show()
    ...
    def kontrol(self):
        ...
        print(f"Birinci kutuya {ka}, ikinci kutuya {sf}")
